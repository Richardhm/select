<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-10">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{asset('logo_bmsys.png')}}" alt="Logo" class="h-8 md:h-12 p-1">
                    </a>
                </div>
            ...
            <div class="shrink-0 flex items-center">
                <a href="{{ route('dashboard') }}">
                    <img src="{{asset('logo_select.png')}}" alt="Logo" class="h-8 md:h-12 p-1">
                </a>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <a class="ml-2" style="color:#366EBF;" title="Tabela Completa" alt="Tabela Completa" href="{{route('tabela_completa.index')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <a class="ml-2" style="color:#366EBF;" title="Historico Financeiro" alt="Editar Seu Perfil" href="{{route('assinatura.historico')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                    </svg>
                </a>

                <a class="ml-2" style="color:#366EBF;" title="Configurações" alt="Configurações" href="{{route('configuracoes.index')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
